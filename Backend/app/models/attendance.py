...
class Attendance(Base):
    ...
    project_worker_id = Column(
        Integer,
        ForeignKey("project_workers.project_worker_id"),
        nullable=False
    )
    ...
    project_worker = relationship(
        "ProjectWorker",
        foreign_keys=[project_worker_id]
    )

    project_contractor = relationship(
        "ProjectContractor",
        foreign_keys=[project_contractor_id]
    )